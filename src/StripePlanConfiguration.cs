...
{
	public const string StarterMonthlyKey = SubscriptionPlanCatalog.StarterMonthlyKey;
	public const string StarterYearlyKey = SubscriptionPlanCatalog.StarterYearlyKey;
	public const string AdvancedMonthlyKey = SubscriptionPlanCatalog.AdvancedMonthlyKey;
	public const string AdvancedYearlyKey = SubscriptionPlanCatalog.AdvancedYearlyKey;
	...
	public static IReadOnlyCollection<StripePlanDetails> GetAllPlans() => Plans.Values.ToArray();
}
